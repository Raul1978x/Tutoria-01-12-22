...
public class JugadorServicio {
    ...
    public Jugador[] listaPreCreada() {
        ...
        Jugador j10 = new Jugador("Itai", 42, "celeste", "castaño", "blanca");
     ...
     * la lista completa y dentro de este for definimos según el valor de i
     * asigna al jugador del equipo azul en la posicion i el valor del jugador
     * de la listaJugadores en la posicion que corresponde al vector valor(con
     * numeros del 0 al 9 distribuidos en forma aleatoria) en la posicion i
     * tambien, luego para el equipoRojo hace algo similar, solo que tiene un
     * contador (cont) que incia desde 0 e incrementa en cada iteracion, con la
     * diferencia que el bucle for empieza desde la numJug -1 (porque recordemos
     * que vamos recorriendo desde 0 a 9) aunque en este caso empieza desde 9 y
     * terminará en 5. Así repartimos a todos nuestros juegadores en los dos
     * equipos. Al mismo tiempo que le asigna el equipo a cada jugador le asigna
     * a cada uno su color de remera como de pantalon.
     *
     */
    ...
    private void edadPromedio(Jugador[] equipo) {
        ...
        System.out.println("\nLa edad promedio del equipo es: " + (double) prom + " Años");
    }
